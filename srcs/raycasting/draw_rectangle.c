...
/*   Updated: 2025/01/22 17:31:54 by mkhoury          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_col2(int x, long color, float len, t_core *core)
{
	...
	y = (int) ((core->imgs.cast->height / 2.f) - core->player[LOCAL].offset - core->player[LOCAL].bubbles + core->player[DISTANT].bubbles) - nb / 2 + (int) (core->imgs.cast->height / 6.f / len);
	while (i < nb)
	{
