...
//     init_face(&player->entity.corps.face[0], (t_pos *[]){&player->entity.corps.points[2], &player->entity.corps.points[3],\
//     &player->entity.corps.points[6],&player->entity.corps.points[7]}, (int []){20, 20}, player->entity.texture);
